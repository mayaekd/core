...
% READMEPlottingParameters

function plottingParameters = READMEPlottingParameters()
    ...
    motorSilhouetteMinOpacity = 0.3;
    motorSilhouetteMaxOpacity = 0.8;
    ...
    junctureSizes = 500;
    resultPointSizes = 300;
    numberOfSilhouetteVertices = 8; % Deprecated
    numberOfPointsBetweenPoints = 10;
    motorBounds = [-5 16; -1 20];
    perceptualBounds = [0 20; 0 30];
    
    plottingParameters = PlottingParameters(clusterColorArray, ...
